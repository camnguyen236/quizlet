      ...
      const updated = await Account.updateOne(
        { _id: req.query.id },
        {
          $set: {
            ...
            "achievement.dayStreak": userAchievement.achievement.dayStreak,
            "achievement.weekStreak": userAchievement.achievement.weekStreak,
          },
        }
      );
      console.log(updated);
